...
import 'package:foodiee_admin/constans/app_constans.dart';
import 'package:foodiee_admin/constans/validator.dart';
import 'package:foodiee_admin/models/product_model.dart';
import 'package:foodiee_admin/services/assets_manager.dart';
import 'package:foodiee_admin/services/myapp_functions.dart';
import 'package:foodiee_admin/widget/loader_manager.dart';
import 'package:foodiee_admin/widget/subtitle_text.dart';
    ...
    return  GestureDetector(
      ...
      child: Scaffold(
                ...
                Row(
                  ...
                  children: [
                    ...
                    ElevatedButton.icon(
                      ...
                      label:  Text(isEditing ? "Save Product" : "Ürün kaydet" ),
        ...
        appBar: AppBar(
            ...
            title:  TitleTextWidget(label: isEditing ? "Edit Product" : "Yeni Ürün")
        ),
